...
namespace Cyjb.Collections
{
	...
	public static class ListExt
	{
		...
		/// <exception cref="System.ArgumentNullException"><paramref name="list"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.InvalidOperationException"><typeparamref name="T"/> 
		/// 类型没有实现 <see cref="System.IComparable{T}"/> 泛型接口。</exception>>>
		/// <overloads>
		/// <summary>
		...
		/// 中的任何元素，则为一个负数，该负数是（最后一个元素的索引加 1）的按位求补。</returns>
		/// <exception cref="System.ArgumentNullException"><paramref name="list"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.InvalidOperationException"><paramref name="comparer"/> 为 <c>null</c>，
		/// 且 <typeparamref name="T"/> 类型没有实现 <see cref="System.IComparable{T}"/> 泛型接口。</exception>
		...
		/// 中的任何元素，则为一个负数，该负数是（最后一个元素的索引加 1）的按位求补。</returns>
		/// <exception cref="System.ArgumentNullException"><paramref name="list"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.ArgumentOutOfRangeException"><paramref name="index"/> 小于 <c>0</c>。</exception>
		/// <exception cref="System.ArgumentException"><paramref name="length"/> 小于 <c>0</c>，
		/// 或与 <paramref name="index"/> 的和大于列表的长度。</exception>
		/// <exception cref="System.InvalidOperationException"><typeparamref name="T"/> 
		/// 类型没有实现 <see cref="System.IComparable{T}"/> 泛型接口。</exception>>
			...
			T value, IComparer<T> comparer)
		{
			...
			Contract.Requires(index + length <= list.Count);
			Contract.Ensures((Contract.Result<int>() >= 0 && Contract.Result<int>() <= list.Count) ||
							 (Contract.Result<int>() < 0 && ~Contract.Result<int>() <= list.Count + 1));
			if (comparer == null)
			{
		...
		/// 中的任何元素，则为一个负数，该负数是（最后一个元素的索引加 1）的按位求补。</returns>
		/// <exception cref="System.ArgumentNullException"><paramref name="list"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.ArgumentNullException"><paramref name="keySelector"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.InvalidOperationException"><typeparamref name="TKey"/> 
		/// 类型没有实现 <see cref="System.IComparable{T}"/> 泛型接口。</exception>
		...
		/// <exception cref="System.ArgumentNullException"><paramref name="keySelector"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.InvalidOperationException"><paramref name="comparer"/> 为 <c>null</c>，
		/// 且 <typeparamref name="TKey"/> 类型没有实现 <see cref="System.IComparable{T}"/> 泛型接口。</exception>
		public static int BinarySearch<TElement, TKey>(this IList<TElement> list, TKey value,
		...
		/// <exception cref="System.ArgumentNullException"><paramref name="list"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.ArgumentNullException"><paramref name="collection"/> 为 <c>null</c>。</exception>
		...
		/// <exception cref="System.ArgumentNullException"><paramref name="list"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.ArgumentNullException"><paramref name="collection"/> 为 <c>null</c>。</exception>
		/// <exception cref="System.ArgumentOutOfRangeException"><paramref name="index"/> 小于 <c>0</c>
		/// 或者大于 <paramref name="list"/> 的长度。。</exception>
