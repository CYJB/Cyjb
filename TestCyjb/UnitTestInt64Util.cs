...
namespace TestCyjb
{
	...
	public class UnitTestInt64Util
	{
		...
		[DataRow(new long[] { 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072,
			262144, 524288, 1048576, 2097152, 4194304, 8388608, 16777216, 33554432, 67108864, 134217728, 268435456 })]
		[DataRow(new long[] { 2305843009213693952, 4611686018427387904, -9223372036854775808, 1, 2, 4, 8, 16 })]
		[DataRow(new long[] { 2145386494, 2145910783, 2146172927, 2146303999, 2146369535, 2146402303, 2146418687, 2146426879 })]
		[DataRow(new long[] { 2146435069, 2146435070, 2146959358 })]
		[DataRow(new long[] { 2147483644, 2415919103, 2550136831, 2617245695, 2650800127 })]
		[DataRow(new long[] { 9223372036854775804, -8070450532247928833, -7493989779944505345, -7205759403792793601 })]
		[DataRow(new long[] { -3, -2, 9223372036854775807, -4611686018427387905, -2305843009213693953 })]
		[DataRow(new long[] { -7, -6, -4, 4611686018427387903, 6917529027641081855, 8070450532247928831 })]
		public void TestNextBitPermutation(long[] values)
		{
