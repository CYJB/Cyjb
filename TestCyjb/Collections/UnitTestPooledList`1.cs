...
/// <summary>
/// <see cref="PooledList{T}"/> 类的单元测试。
/// </summary>
[TestClass]
public class UnitTestPooledList
{
	/// <summary>
	/// 测试默认构造函数。
	/// </summary>
	...
	{
		using var list = new PooledList<char>();
	...
	{
		using var list = new PooledList<char>(1);
		Assert.AreEqual(0, list.Length);
	...
	public void Add_String_Large_MatchesStringBuilder(int initialLength, int stringLength)
	{
		...
		using var list = new PooledList<char>(initialLength);
	...
	/// <summary>
	/// 测试 <see cref="PooledList{T}.AsSpan"/>。
	/// </summary>
	[TestMethod]
	...
	/// <summary>
	/// 测试 <see cref="PooledList{T}.TryCopyTo"/>。
	/// </summary>
	[TestMethod]
	...
	/// <summary>
	/// 测试在 <see cref="PooledList{T}.Dispose"/> 后重复使用。
	/// </summary>
	[TestMethod]
	...
	/// <summary>
	/// 测试 <see cref="PooledList{T}.EnsureCapacity"/>。
	/// </summary>
	[TestMethod]
	public void TestEnsureCapacity()
	{
		using var list = new PooledList<char>(32);
	...
	/// <summary>
	/// 测试 <see cref="PooledList{T}.EnsureCapacity"/> 加倍缓存的场景。
	/// </summary>
	[TestMethod]
	...
	/// <summary>
	/// 测试 <see cref="PooledList{T}.EnsureCapacity"/> 不修改容量的场景。
	/// </summary>
	[TestMethod]
