...
using Node = TestCyjb.Collections.TestCharSet.AVLTree<char, char>.Node;
...
namespace TestCyjb.Collections.TestCharSet
{
	...
	public sealed class RangeCharSet : SetBase<char>, IEquatable<CharSet>, IRangeCollection<char>
	{
		/// <summary>
		...
		/// </summary>
		public RangeCharSet() : base() { }
		/// <summary>
		/// 使用指定的元素初始化 <see cref="CharSet"/> 类的新实例。
		/// </summary>
		/// <param name="collection">初始化的字符集合。</param>
		public RangeCharSet(IEnumerable<char> collection) : base()
		{
		...
		public override bool IsProperSubsetOf(IEnumerable<char> other)
		{
			...
			if (other is RangeCharSet otherSet)
			{
