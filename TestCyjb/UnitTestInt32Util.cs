...
namespace TestCyjb
{
	...
	public class UnitTestInt32Util
	{
		...
		[DataRow(new int[] { 0, 0 })]
		[DataRow(new int[] { -1, -1 })]
		[DataRow(new int[] { 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072,
		...
		[DataRow(new int[] { 2145386494, 2145910783, 2146172927, 2146303999, 2146369535, 2146402303, 2146418687, 2146426879 })]
		[DataRow(new int[] { 2146435069, 2146435070, 2146959358 })]
		[DataRow(new int[] { 2147483644, -1879048193, -1744830465, -1677721601, -1644167169 })]
		[DataRow(new int[] { -3, -2, 2147483647, -1073741825, -536870913 })]
		[DataRow(new int[] { -7, -6, -4, 1073741823, 1610612735, 1879048191, 2013265919 })]
		public void TestNextBitPermutation(int[] values)
		{
