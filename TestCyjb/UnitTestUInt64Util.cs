...
namespace TestCyjb
{
	...
	public class UnitTestUInt64Util
	{
		...
		[DataTestMethod]
		[DataRow(0UL, 0UL)]
		[DataRow(21UL, 22UL, 25UL, 26UL, 28UL, 35UL)]
		[DataRow(18446744073709551615UL, 18446744073709551615UL)]
		[DataRow(1UL, 2UL, 4UL, 8UL, 16UL, 32UL, 64UL, 128UL, 256UL, 512UL, 1024UL, 2048UL, 4096UL, 8192UL, 
			16384UL, 32768UL, 65536UL, 131072UL, 262144UL, 524288UL, 1048576UL, 2097152UL, 4194304UL, 
			8388608UL, 16777216UL, 33554432UL, 67108864UL, 134217728UL, 268435456UL)]
		[DataRow(2305843009213693952UL, 4611686018427387904UL, 9223372036854775808UL, 1UL, 2UL, 4UL, 8UL, 16UL)]
		[DataRow(2145386494UL, 2145910783UL, 2146172927UL, 2146303999UL, 2146369535UL, 2146402303UL, 2146418687UL, 2146426879UL)]
		[DataRow(2146435069UL, 2146435070UL, 2146697215UL)]
		[DataRow(2147483644UL, 2415919103UL, 2550136831UL, 2617245695UL, 2650800127UL)]
		[DataRow(9223372036854775804UL, 10376293541461622783UL, 10952754293765046271UL, 11240984669916758015UL)]
		[DataRow(18446744073709551613UL, 18446744073709551614UL, 9223372036854775807UL, 13835058055282163711UL)]
		[DataRow(18446744073709551609UL, 18446744073709551610UL, 18446744073709551612UL, 4611686018427387903UL,
			6917529027641081855UL, 8070450532247928831UL)]
		public void TestNextBitPermutation(params ulong[] values)
		{
